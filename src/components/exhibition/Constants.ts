...
* Model Resources
* */
export const COLLISION_SCENE_URL = new URL("/models/scene_collision1.glb", import.meta.url).href;
export const STATIC_SCENE_URL = new URL("/models/scene_desk_obj.glb", import.meta.url).href;

/*
* Texture Resources
* */
export const BOARD_TEXTURES = [
	new URL("/boards/1.png", import.meta.url).href,
	new URL("/boards/2.png", import.meta.url).href,
	new URL("/boards/3.jpg", import.meta.url).href,
	new URL("/boards/4.jpg", import.meta.url).href,
	new URL("/boards/5.png", import.meta.url).href,
	new URL("/boards/6.png", import.meta.url).href,
	new URL("/boards/7.png", import.meta.url).href,
...
* Audio Resources
* */
export const AUDIO_URL = new URL("/audio/我记得.m4a", import.meta.url).href;
